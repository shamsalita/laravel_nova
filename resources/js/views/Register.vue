        ...
        <b-container>
            <b-row>
                <b-col md="8">
                    ...
                    <b-alert variant="success" v-model="showAlert" v-text="alertMessage"></b-alert>
                    ...
                    <b-form method="post" @submit.prevent="registrationProcess">
                        ...
                        <b-form-group id="gender-group" label="Gender">
                            <b-form-radio-group v-model="user_details.gender" :options="gender_options" ></b-form-radio-group>
                        ...
                        <b-form-group id="country-group" label="Country">
                            <b-form-select v-model="user_details.country_code" :options="countries"></b-form-select>
